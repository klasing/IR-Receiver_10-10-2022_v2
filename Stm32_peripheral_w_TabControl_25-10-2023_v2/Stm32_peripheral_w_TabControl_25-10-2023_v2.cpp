// Stm32_peripheral_w_TabControl_25-10-2023_v2.cpp : Defines the entry point for the application.
//
...
//****************************************************************************
#include "framework.h"
#include "Stm32_peripheral_w_TabControl_25-10-2023_v2.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_STM32PERIPHERALWTABCONTROL25102023V2, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_STM32PERIPHERALWTABCONTROL25102023V2));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_STM32PERIPHERALWTABCONTROL25102023V2));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_STM32PERIPHERALWTABCONTROL25102023V2);
