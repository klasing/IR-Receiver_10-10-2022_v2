// All_8_Peripheral_05-11-2023_v3.cpp : Defines the entry point for the application.
//
...
//****************************************************************************
#include "framework.h"
#include "All_8_Peripheral_05-11-2023_v3.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_ALL8PERIPHERAL05112023V3, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_ALL8PERIPHERAL05112023V3));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ALL8PERIPHERAL05112023V3));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_ALL8PERIPHERAL05112023V3);
